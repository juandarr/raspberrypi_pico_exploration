...
(char *)"20thCenturyFox:d=16,o=5,b=140:b,8p,b,b,2b,p,c6,32p,b,32p,c6,32p,b,32p,c6,32p,b,8p,b,b,b,32p,b,32p,b,32p,b,32p,b,32p,b,32p,b,32p,g#,32p,a,32p,b,8p,b,b,2b,4p,8e,8g#,8b,1c#6,8f#,8a,8c#6,1e6,8a,8c#6,8e6,1e6,8b,8g#,8a,2b",
...
void begin_rtttl(int idx, char *p)
{
  ...
  if (nameLength > 0 && nameLength < sizeof(nameBuffer)) {
    ...
    tft.drawString(cstr, 20, 300, GFXFF);// Print the string name of the font
  }
  p++;                     // skip ':'
